...
public class Main_wrapper {
	...
	public static void main(String[] args) {
		...
		System.out.println( (char)(ch-32) ); // (int)ch-32  97-32  65  (char)65   A 
	...
	//	Character chr = new Character('a');
		...
		if(Character.isUpperCase(c) ) { // 대문자 인지 알아본다.
			System.out.println("첫글자 "+ c +" 는 대문자 입니다.");
		}
		
		else if(Character.isLowerCase(c)) { // 소문자 인지 알아본다.
			System.out.println("첫글자 "+ c +" 는 소문자 입니다.");
		}
	...
	//	else if(44032 <= (int)c && (int)c <= 55203) { // 한글 인지 알아본다.
			...
			System.out.println("첫글자 "+ c +" 는 특수문자 입니다.");
		}
