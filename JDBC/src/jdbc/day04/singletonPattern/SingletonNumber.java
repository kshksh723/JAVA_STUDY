...
public class SingletonNumber {
	...
	*/   
	...
	// --> field (첫번째로 작동) <-- //
	// static 변수로 만든다 
	private static SingletonNumber singleton = null; //초기화를 안해도 널이다 
	...
	static {
		...
		System.out.println(">> ~~~ 확인용 SingletonNumber 클래스의 static 초기화 블록 호출됨 ~~~ <<");
		
		singleton = new SingletonNumber(); // null 이 아니다 
	}
