...
public class Main {
	...
	public static void main(String[] args) {
		...
		ma.a_method();
		/*
		aObj =>jdbc.day04.singletonPattern.NoSingletonNumber@73a28541
		a_method() 메소드에서 cnt 값 호출 : 1
		 */
		
		ma.b_method();
		/*
		  bObj =>jdbc.day04.singletonPattern.NoSingletonNumber@4fccd51b
			b_method() 메소드에서 cnt 값 호출 : 1
		 */
		ma.c_method();
		/*
		 cObj =>jdbc.day04.singletonPattern.NoSingletonNumber@44e81672
		c_method() 메소드에서 cnt 값 호출 : 1
		 */
		System.out.println("\n"+ "=".repeat(50)+"\n");
		
		/*
		 * SingletonNumber single_1 = new SingletonNumber(); SingletonNumber single_2 =
		 * new SingletonNumber(); --> 이건 접근제한자때문에 못쓴다
		 */
		ma.d_method();
		/*
