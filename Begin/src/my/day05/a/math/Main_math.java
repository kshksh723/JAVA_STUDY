...
public class Main_math {
	...
	public static void main(String[] args) {
		...
		System.out.println("\n == 반올림 한 후 ===\n");
		System.out.println("db1 =>" +Math.round(db1) +", db2 =>" + Math.round(db2)); //static 메소드
		//db1 =>93, db2 =>87
		...
		// 86.87654 * 100	==>	86.87654 ==> Math.round(8687.654) ==> 8688 ==> 8688 / 100.0 ==> 86.88
		...
		// 2. >> 올림에 대해서 알아본다 << ==> 웹에서 게시판 작성 시 사용된다
		// 54.0 ==> 54.0 // 소수부가 0일 때만 0이다 ==> 54 (웹에서 이렇게 쓰임)
		// 54.1 ==> 55.0 ==> 55(웹에서 이렇게 쓰임)
		// 54.9 ==> 55.0 ==> 55 (웹에서 이렇게 쓰임)
		
		double db3 = 54.0, db4= 54.1, db5 = 54.9;
		System.out.println("\n=== 올림 한 후===");
		System.out.println("db3 =>" + Math.ceil(db3) + ", db4 =>" + Math.ceil(db4) + ",db5=>" + Math.ceil(db5)); // 실수를 돌려주는 것
		// db3 =>54.0, db4 =>55.0,db5=>55.0
		
		// .0 소수부 없애기 , 강제 형변환 (웹에서 많이 쓰임), 소수가 있으면 정수로 바꿔버림
		...
		// 3. >> 내림에 대해서 알아본다 <<  잘 안쓰임
		// 54.0 ==> 54.0 // 소수부가 0일 때만 0이다 ==> 54 (웹에서 이렇게 쓰임)
		// 54.1 ==> 54.0 ==> 54(웹에서 이렇게 쓰임)
		// 54.9 ==> 54.0 ==> 54 (웹에서 이렇게 쓰임)
		
		db3 = 54.0; db4= 54.1; db5 = 54.9;
		System.out.println("\n=== 내림 한 후===");
		System.out.println("db3 =>" + Math.floor(db3) + ", db4 =>" + Math.floor(db4) + ",db5=>" + Math.floor(db5)); // 실수를 받아서 실수로 돌려주는 것
