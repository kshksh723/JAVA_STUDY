...
import my.day17.b.user_define_exception.Jango_lack_Exception;
import my.day17.b.user_define_exception.Product;
...
// public class Product_imple extends Object implements Product { 와 같은 것이다
	...
	// 주문받기 2
		...
		public void jumun(int jumun_su) throws Jango_lack_Exception {
			...
			if(jango < jumun_su) {
				throw new Jango_lack_Exception(">>"  + prod_name + "은 잔고가 " +jango+" 개 인데 주문량이 " + jumun_su+ "개라서 잔고부족으로 주문이 불가합니다<< ");
			}
			else {
				System.out.println(prod_name + " 제품을 " + jumun_su + " 개를 주문하셨습니다");
				jango -= jumun_su;
 ...
 } //  end of public class Product_imple implements Product
