		 ...
		 System.out.println("\n~~~~~~~~~~~~~~~~~~~~~~~~~~~~\n");   
		   ...
		   */   
		   ...
		   System.out.println("올 해의 년도 : " + year);
		    ...
		    System.out.println("월(0~12, 1:1월): " + strMonth2);
		    
		    System.out.println("이 해의 몇 째 주: " + currentDate.get(Calendar.WEEK_OF_YEAR));		// 이 해의 몇 째 주: 5     오늘 날짜부터 WEEK_OF_YEAR, 올해의 첫~다섯째주
			System.out.println("이 달의 몇 째 주: " + currentDate.get(Calendar.WEEK_OF_MONTH)); /* 이 달의 몇 째 주: 5 */
