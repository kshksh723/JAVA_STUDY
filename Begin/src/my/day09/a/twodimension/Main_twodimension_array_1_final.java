...
public class Main_twodimension_array_1_final {
...
*/	
		...
		*/
		...
		//배열 속에 저장되어있는 것을 꺼내오는 두번째 방법!!
		for(int subject_total : arr_subject_total) {
			// 반복의 횟수는 arr_subject_total 배열의 길이만큼 한다
			//배열의길이만큼 반복되는 for문 : "확장 for문 " 또는 개선된 for문
